    ...
    public function run(): void
    {
        ...
        $books = [
            [
                ...
                'description' => '猫の視点から、明治時代の人間社会を風刺的に描いた小説です。',
            ...
            [
                ...
                'description' => '良好な人間関係を築き、人に働きかけるための原則を解説した書籍です。',
            ...
            [
                ...
                'description' => '読みやすく理解しやすいコードを書くための実践的な技術を解説した書籍です。',
            ...
            [
                ...
                'description' => '主体性や目標設定など、効果的に行動するための習慣を解説した書籍です。',
            ...
            [
                ...
                'description' => '正義感の強い教師が地方の学校で経験する騒動を描いた小説です。',
            ...
            [
                ...
                'description' => '人類の誕生から現代までの歴史を、科学的な視点から考察した書籍です。',
            ...
            [
                ...
                'description' => '保守しやすく意図が伝わるコードを書くための原則を解説した技術書です。',
            ...
            [
                ...
                'description' => 'アドラー心理学を対話形式で紹介し、自分らしく生きる考え方を伝える書籍です。',
            ...
            [
                ...
                'description' => '二人の芸人の交流を通して、才能や生き方を描いた小説です。',
            ...
            [
                ...
                'description' => 'データをもとに、世界の現状を正しく捉えるための思考法を紹介した書籍です。',
            ...
            [
                ...
                'description' => '物流用コンテナが世界経済と輸送の仕組みを変えた歴史を描いた書籍です。',
